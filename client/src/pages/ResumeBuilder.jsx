...
const ResumeBuilder = () => {
  ...
  const downloadResume = () => {
    // Option 1: trigger browser print dialog
    window.print();

    // Option 2 (advanced): use html2pdf or react-to-print for real PDF export
    // html2pdf(document.getElementById('resume-preview'));
  };
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <div className="space-y-6">
                ...
                <ProjectForm
                  ...
                  onChange={(data) =>
                    setResumeData(prev => ({
                      ...prev,
                      project: data,   // ✅ must match state key
                    }))
                  }
                />
              )}
              ...
              <button className="bg-gradient-to-br from-green-100 to-green-200 right-green-300 text-green-600 ring hover:ring-green-400 
            ...
            <div className="relative w-full">
              ...
              justify-end gap-2">
                ...
                <button onClick={changeResumeVisibility} className="flex items-center p-2 px-4 gap-2 text-xs
                  ...
                  rounded-lg ring-pruple-300 hover:ring transition-colors">
